...
public class Libretto {
	...
	// l'alternativa è Deep (copia profonda) clona gli elemnti, shallow mantiene gli stessi oggetti in una lista diversa
	/**
	 * Copy Constructor
	 ...
	 * inserito perchè era in conflitto oppure era duplicato.
	 */
	...
	/**
	 * Dato il nome di un corso, ricerca se quel'esame esiste
	...
	/**
	 * Ritorno [{@code true} se il corso specificato da {@code v}
	 * esiste nel lbretto, con la stessa valutazione.
